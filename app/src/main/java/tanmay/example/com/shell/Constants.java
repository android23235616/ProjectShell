package tanmay.example.com.shell;
...
public class Constants {
    ...
    public final static String SHARED_PREF="MySharedPref1997";
    public static final String REGISTERED = "registered";
    public static final String UNIQUE_ID = "uniqueid";
    public static final String USER_DATA_SHARED_PREF = "usersharedpref";
